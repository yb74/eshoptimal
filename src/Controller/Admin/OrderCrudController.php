...
class OrderCrudController extends AbstractCrudController
{
    ...
    public function updatePreparation(AdminContext $context)
    {
        ...
        $this->addFlash('notice', "<span style='color: green'><strong>The preparation of the order ". $order->getReference() . " is in progress</strong></span>");
    ...
    public function updateDelivery(AdminContext $context)
    {
        ...
        $this->addFlash('notice', "<span style='color: orange'><strong>The delivery of the order ". $order->getReference() . " is in progress</strong></span>");
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            MoneyField::new('total', 'Total product')->setCurrency("EUR"),
